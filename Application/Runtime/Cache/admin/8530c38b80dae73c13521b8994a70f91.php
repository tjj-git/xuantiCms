...
<ul class="breadcrumb">当前位置：
  ...
  <a href="#">课程类型管理</a> <span class="divider">/</span>
   ...
   <div class="title_right"><strong>课程类型编辑</strong></div>
<div style="width:900px;margin:auto;">
    <form action="/xuantiCms/type/edit" method="post">
        ...
        <table class="table table-bordered" >
            ...
            <tr>
                ...
                <td width="38%"><input type="text" name="count" id="count" class="span1-1"  value="<?php echo ($data[0]["count"]); ?>"/>门</td>
            </tr>
            <tr>
