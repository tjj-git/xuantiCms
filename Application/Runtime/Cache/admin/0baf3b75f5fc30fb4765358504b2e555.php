...
<ul class="breadcrumb">当前位置：
  ...
  <a href="#">班级管理</a> <span class="divider">/</span>
  班级列表
</ul>
   
   <div class="title_right"><strong>班级列表</strong></div>
    ...
    <table class="table table-bordered">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td align="center"><?php echo (date('Y-m-d H:i',$v["create_date"])); ?></td>
                <td align="center">
                    <a href="/xuantiCms/class/editUI/id/<?php echo ($v["id"]); ?>">编辑</a>
                    <a href="/xuantiCms/class/delete/id/<?php echo ($v["id"]); ?>" onclick="javascript:return p_del()">删除</a>
                </td>
