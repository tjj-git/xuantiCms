...
<ul class="breadcrumb">当前位置：
  ...
  <a href="#">课程类型管理</a> <span class="divider">/</span>
   ...
   <div class="title_right"><strong>课程类型列表</strong></div>
<div class="modal-body">
    <table class="table table-bordered">
        <tr>
            <th bgcolor="#f1f1f1">id</th>
            <th bgcolor="#f1f1f1">名称</th>
            <th bgcolor="#f1f1f1">每人限选修</th>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td align="center"><?php echo ($v["name"]); ?></td>
                <td align="center"><?php echo ($v["count"]); ?>门</td>
            <td align="center"><?php echo ($v["desc"]); ?></td>
            <td align="center"><?php echo (date('Y-m-d H:i',$v["create_date"])); ?></td>
                <td align="center">
                    <a href="/xuantiCms/type/editUI/id/<?php echo ($v["id"]); ?>">编辑</a>
                    <a href="/xuantiCms/type/delete/id/<?php echo ($v["id"]); ?>" onclick="javascript:return p_del()">删除</a>
                </td>
