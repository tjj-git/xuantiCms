...
<ul class="breadcrumb">当前位置：
  ...
  教师列表
   ...
   <div class="title_right"><strong>教师列表</strong></div>
         <div class="modal-body" style="height: auto;">
             <table class="table table-bordered">
                 <form action="/xuantiCms/teacher/index" method="get" id="form">
                     <tr>
                         <td>姓名:<input name="name" type="text"/></td>
                         <td>教师编号:<input name="number" type="text"/></td>
             ...
             <table class="table table-bordered">
                 ...
                 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                         ...
                         <td align="center"> <a href="/xuantiCms/teacher/my_student_subject/teacher_id/<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></a></td>
                         <td align="center"><?php echo ($v["teachernumber"]); ?></td>
                         ...
                         <td align="center">
                             <a href="/xuantiCms/teacher/editUI/id/<?php echo ($v["id"]); ?>">编辑</a>
                             <a href="/xuantiCms/teacher/delete/id/<?php echo ($v["id"]); ?>" onclick="javascript:return p_del()">删除</a>
                         </td>
