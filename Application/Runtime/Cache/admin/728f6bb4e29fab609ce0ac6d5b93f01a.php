...
<ul class="breadcrumb">当前位置：
  ...
  课程列表
   ...
   <div class="title_right"><strong>课程列表</strong></div>
         <div class="modal-body" style="height: auto;">
             ...
             <table class="table table-bordered">
                 ...
                 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                         ...
                         <td align="center">
                             <?php if($user['flag']==3): if($v['no_selected']==0): ?>已满
                                     <?php else: ?>
                                     <a href="/xuantiCms/student/select_subject/subject_id/<?php echo ($v["id"]); ?>">选课</a><?php endif; endif; ?>
                             ...
                             <?php if($user['flag']==2): if($user['id']==$v['teacher_id']): ?><a href="/xuantiCms/subject/editUI/id/<?php echo ($v["id"]); ?>">编辑</a>
                                     <a href="/xuantiCms/subject/delete/id/<?php echo ($v["id"]); ?>" onclick="javascript:return p_del()">删除</a>
