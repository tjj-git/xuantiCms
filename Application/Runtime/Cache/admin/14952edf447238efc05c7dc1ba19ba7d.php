...
<ul class="breadcrumb">当前位置：
  ...
  <a href="#">课程类型管理</a> <span class="divider">/</span>
    课程类型添加
</ul>
   
   <div class="title_right"><strong>课程类型添加</strong></div>
<div style="width:900px;margin:auto;">
    <form action="/xuantiCms/type/add" method="post">
        <table class="table table-bordered" >
            <tr>
                <td width="12%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">名称：</td>
                <td width="38%"><input type="text" name="name" id="input" class="span1-1"  /></td>
            </tr>
            <tr>
                <td width="12%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">每人只能选择：</td>
                <td width="38%"><input type="text" name="count" id="count" class="span1-1"  />门</td>
            </tr>
            <tr>
                <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">描述：</td>
                <td colspan="3"><textarea name="desc" id="input9" class="span10"></textarea></td>
            </tr>
